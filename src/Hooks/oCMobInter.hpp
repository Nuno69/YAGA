...
{
// Makes the game more benevolent to interaction accuracy, e.g. allows to interact with an NPC even if the character is
// not facing it.
auto Hook_oCMobInter_SearchFreePosition =
    Union::CreateHook(SIGNATURE_OF(&oCMobInter::SearchFreePosition), &oCMobInter::SearchFreePosition_Union,
