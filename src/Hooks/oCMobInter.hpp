namespace GOTHIC_NAMESPACE {
	...
	auto Hook_oCMobInter_SearchFreePosition = Union::CreateHook(SIGNATURE_OF(&oCMobInter::SearchFreePosition), &oCMobInter::SearchFreePosition_Union, Union::HookType::Hook_CallPatch);
#if ENGINE >= Engine_G2
