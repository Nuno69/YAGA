namespace GOTHIC_NAMESPACE {
	...
	auto Hook_oCAIHuman_StartFlyDamage = Union::CreateHook(SIGNATURE_OF(&oCAIHuman::StartFlyDamage), &oCAIHuman::StartFlyDamage_Union, Union::HookType::Hook_CallPatch);
	...
	auto Hook_oCAIHuman_PC_Turnings = Union::CreateHook(SIGNATURE_OF(&oCAIHuman::PC_Turnings), &oCAIHuman::PC_Turnings_Union, Union::HookType::Hook_Detours);
