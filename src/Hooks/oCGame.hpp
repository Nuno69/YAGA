namespace GOTHIC_NAMESPACE {
	...
	auto Hook_oCGame_SetupPlayers = Union::CreateHook(reinterpret_cast<void*>(zSwitch(0x006C3FA0, 0x006C3FA0, 0, 0)), &oCGame::Hook_SetupPlayers, Union::HookType::Hook_Detours);
