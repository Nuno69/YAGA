namespace GOTHIC_NAMESPACE {
	...
	auto Hook_oCNpc_SetWalkStopChasm = Union::CreateHook(SIGNATURE_OF(&oCNpc::SetWalkStopChasm), &oCNpc::Hook_SetWalkStopChasm, Union::HookType::Hook_Detours);
	...
	auto Patch_oCNpc_FreeLineOfSight = Union::CreateHook(SIGNATURE_OF((int (oCNpc::*)(zVEC3&, zCVob*))&oCNpc::FreeLineOfSight), &oCNpc::Patch_FreeLineOfSight, Union::HookType::Hook_CallPatch);
	...
	auto Hook_oCNpc_Disable_Union = Union::CreateHook(SIGNATURE_OF(&oCNpc::Disable), &oCNpc::Hook_Disable, Union::HookType::Hook_Detours);
