...
namespace GOTHIC_NAMESPACE {
	...
	public:
		...
		void SortNPCByDistanceFromPlayer()
		{
			...
			std::sort(nearbyNPC.begin(), nearbyNPC.end(), [&playerPosition](oCNpc* lh, oCNpc* rh) {return (lh->GetDistanceToPos2(playerPosition, 0) < rh->GetDistanceToPos2(playerPosition, 0)); });
		}
